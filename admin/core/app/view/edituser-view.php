<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <br>
      <form class="form-horizontal" method="post" id="addproduct" action="index.php?action=updateuser&opt=editusers" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="text" name="email" value="<?php echo $user->email; ?>" class="form-control" id="email" placeholder="Email" required>
          </div>
        </div>
