            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <!-- Menu Footer-->
                  <?php $ux = PostData::getAllActive();
                  if (count($ux) > 0) :
                  ?>
                    <li class="header"> Tienes notificaciones de Posts</li>
                    <li class="user-footer">
                      <?php foreach ($ux as $post) : ?>
                        <a href="#">
                          <i class="fa fa-paste text-aqua"></i>Nueva Publicación: <?php echo $post->title; ?>
                          <a href="index.php?action=posts&opt=viewer&id=<?php echo $post->id; ?>" class="btn btn-info btn-xs">Aceptar</a>
                          </br>
                        </a>
                      <?php endforeach; ?>
                    </li>
                  <?php else : ?>
                    <i class=""></i> No tienes notificaciones de Publicaciones </br>
                  <?php endif; ?>

                  </hr>

                  <?php $us = UserData::getAllActive();
                  if (count($us) > 0) :
                  ?>
                    <li class="header"> Tienes notificaciones de Usuarios</li>
                    <li class="user-footer">
                      <?php foreach ($us as $userss) : ?>
                        <a href="#">
                          <i class="fa fa-users text-aqua"></i>Nuevo Usuario: <?php echo $userss->name; ?>
                          <a href="index.php?action=posts&opt=userss&id=<?php echo $userss->id; ?>" class="btn btn-info btn-xs">Aceptar</a>
                          </br>
                        </a>
                      <?php endforeach; ?>
                    </li>
                  <?php else : ?>
                    <i class=""></i> No tienes notificaciones de Usuarios
                  <?php endif; ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                      ...
                      <?php endif; ?>
                      <a href="http://localhost/forus/master_foro/" class="btn btn-default btn-flat">Foro</a>
          ...
          <ul class="sidebar-menu">
            ...
            <?php if (isset($_SESSION["user_id"])) : ?>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="./?view=admins"><i class="fa fa-circle-o"></i> Administradores</a></li>
                </ul>
                <ul class="treeview-menu">
                  <li><a href="./?view=users"><i class="fa fa-circle-o"></i> Usuarios</a></li>
                </ul>
              </li>
